...
public class TenantBillingDashboardService {
    ...
    private TenantBillingDashboard.Features buildFeatures(legacy.saasbilling.tenant.entity.Plan plan) {
        if (plan == null) {
    ...
    private List<TenantBillingDashboard.Recommendation> buildRecommendations(UsageLimitsResponse usage, 
            Integer trialDaysRemaining, legacy.saasbilling.tenant.entity.Plan plan) {
